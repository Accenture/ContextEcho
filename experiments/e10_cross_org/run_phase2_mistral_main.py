"""Phase 2 main: Mistral Large × 5 conditions × 25 probes × 2 judges.

Pre-registration: PREREG_AMENDMENT_MISTRAL.md
SHA-256 (pre-signature): 187d0c602134a7e75e7f6936f8f73ba58810d4345c9714c51d71335e3087d61a
...
Outputs:
  data_archive/mistral_panel/phase2_main/
    PHASE2_RESULTS.json
    PHASE2_LOG.txt
    target__mistral-large-latest__<condition>.json
    sonnet__mistral-large-latest__<condition>.json
    gpt5__mistral-large-latest__<condition>.json
...
PHASE2_DIR = REPO_ROOT / "data_archive" / "mistral_panel" / "phase2_main"
...
# Mistral la Plateforme pricing for mistral-large-latest (mistral-large-2512)
# is approximately $2/M input, $6/M output as of 2026-04-29. Used for
# in-script cost tracking only; real billing comes from console.mistral.ai.
PRICING = {
...
def main() -> int:
    ...
    log(f"Pre-reg: PREREG_AMENDMENT_MISTRAL.md "
        f"sha256=187d0c602134a7e75e7f6936f8f73ba58810d4345c9714c51d71335e3087d61a")
    ...
    out = {
        "phase": "phase2_main",
        "prereg_amendment_sha256": "187d0c602134a7e75e7f6936f8f73ba58810d4345c9714c51d71335e3087d61a",
        "target_model": TARGET,
