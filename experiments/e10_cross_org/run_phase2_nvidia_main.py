"""Phase 2 main: NVIDIA Nemotron 120B × 5 conditions × 25 probes × 2 judges.

Pre-registration: PREREG_AMENDMENT_NVIDIA.md
SHA-256 (pre-signature): 6ffffb263eb5a8987492725c40108ebe698e661ce53b7f0b9e5abade319c9134
...
PHASE2_DIR = REPO_ROOT / "data_archive" / "nvidia_panel" / "phase2_main"
...
# NVIDIA NIM API pricing for nvidia/nemotron-3-super-120b-a12b is on a
...
PRICING = {
    "nvidia/nemotron-3-super-120b-a12b": {"in": 2.00, "out": 5.00},
...
def main() -> int:
    ...
    log(f"Pre-reg: PREREG_AMENDMENT_NVIDIA.md "
        f"sha256=6ffffb263eb5a8987492725c40108ebe698e661ce53b7f0b9e5abade319c9134")
    ...
    out = {
        "phase": "phase2_main",
        "prereg_amendment_sha256": "6ffffb263eb5a8987492725c40108ebe698e661ce53b7f0b9e5abade319c9134",
        "target_model": TARGET,
