"""Phase 2 main: Cohere Command A × 5 conditions × 25 probes × 2 judges.

Pre-registration: PREREG_AMENDMENT_COHERE.md
SHA-256 (pre-signature): 50a418fae14d841b4e216d0f5b55bad497f761189d49ce59dc7033a36bb30aa4
...
Outputs:
  data_archive/cohere_panel/phase2_main/
    PHASE2_RESULTS.json
    PHASE2_LOG.txt
...
PHASE2_DIR = REPO_ROOT / "data_archive" / "cohere_panel" / "phase2_main"
PHASE2_RESULTS = PHASE2_DIR / "PHASE2_RESULTS.json"
PHASE2_LOG = PHASE2_DIR / "PHASE2_LOG.txt"

TARGET = "command-a-03-2025"
...
# Cohere pricing for command-a-03-2025 is on a
...
PRICING = {
    "command-a-03-2025": {"in": 2.00, "out": 5.00},
...
def main() -> int:
    ...
    log(f"Pre-reg: PREREG_AMENDMENT_COHERE.md "
        f"sha256=50a418fae14d841b4e216d0f5b55bad497f761189d49ce59dc7033a36bb30aa4")
    ...
    out = {
        "phase": "phase2_main",
        "prereg_amendment_sha256": "50a418fae14d841b4e216d0f5b55bad497f761189d49ce59dc7033a36bb30aa4",
        "target_model": TARGET,
