"""Phase 2 main: Cohere Command R7B × 5 conditions × 25 probes × 2 judges.

Pre-registration: PREREG_AMENDMENT_COHERE.md
SHA-256 (pre-signature): c9aaa4398c86af3f1af4e9864dc5687bc3843695f7005a6f2adbc745e8598b71
...
Outputs:
  data_archive/cohere_panel/phase2_r7b/
    PHASE2_RESULTS.json
    PHASE2_LOG.txt
...
PHASE2_DIR = REPO_ROOT / "data_archive" / "cohere_panel" / "phase2_r7b"
PHASE2_RESULTS = PHASE2_DIR / "PHASE2_RESULTS.json"
PHASE2_LOG = PHASE2_DIR / "PHASE2_LOG.txt"

TARGET = "command-r7b-12-2024"
...
# Cohere pricing for command-r7b-12-2024 is on a
...
# is from console.cohere.com.
PRICING = {
    "command-r7b-12-2024": {"in": 2.00, "out": 5.00},
...
def run_target_cell(target_client, condition, prior, cost_running) -> dict:
    ...
    for i, probe in enumerate(ALL_PROBES):
        ...
        try:
            resp_text, in_tok, out_tok = call_cohere(target_client, TARGET, msgs)
...
def main() -> int:
    ...
    log(f"Pre-reg: PREREG_AMENDMENT_COHERE.md "
        f"sha256=c9aaa4398c86af3f1af4e9864dc5687bc3843695f7005a6f2adbc745e8598b71")
    log(f"Output dir: {PHASE2_DIR}")

    target_client = make_cohere_client()
    ...
    out = {
        "phase": "phase2_main",
        "prereg_amendment_sha256": "c9aaa4398c86af3f1af4e9864dc5687bc3843695f7005a6f2adbc745e8598b71",
        "target_model": TARGET,
