...
class WebTests(unittest.TestCase):
    ...
    def test_pick_session_explains_research_value_fit(self):
        ...
        self.assertIn('<span class="fit-chip donated" data-tooltip="${escapeHtml(donatedSummaryTitle)}" aria-label="${escapeHtml(donatedSummaryTitle)}">Donated ${donatedTotal}</span>', INDEX_HTML)
