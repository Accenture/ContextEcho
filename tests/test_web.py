...
class WebTests(unittest.TestCase):
    ...
    def test_pick_session_explains_research_value_fit(self):
        ...
        self.assertIn('<span class="pill long"><span class="fit-star">&#9733;</span>Good</span> 50+ turns', INDEX_HTML)
        ...
        self.assertIn("t>=50?'long':'improve'", INDEX_HTML)
    ...
    def test_donation_fit_thresholds(self):
        ...
        self.assertEqual(donation_fit(50, 0), "long")
