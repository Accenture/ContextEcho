...
class WebTests(unittest.TestCase):
    ...
    def test_not_ready_sessions_offer_resume_project_actions(self):
        ...
        self.assertIn("Copy /resume steps", INDEX_HTML)
        ...
        self.assertIn("/resume steps copied. See the highlighted instruction above the session list.", INDEX_HTML)
        self.assertIn("Project folder opened. The highlighted instruction shows the /resume step.", INDEX_HTML)
        self.assertIn("Use the /resume pill or row arrow to open/copy its project folder", INDEX_HTML)
