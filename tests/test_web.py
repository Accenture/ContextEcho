...
class WebTests(unittest.TestCase):
    ...
    def test_donated_rows_show_copyable_support_submission_id(self):
        ...
        self.assertIn("beginMetadataUpdate(s, donationInfo.supportId)", INDEX_HTML)
        ...
        self.assertNotIn("sessionMenu", INDEX_HTML)
        self.assertNotIn("showSessionMenu", INDEX_HTML)
    ...
    def test_not_ready_sessions_offer_resume_project_actions(self):
        ...
        self.assertNotIn("session-chevron", INDEX_HTML)
        self.assertNotIn("hideSessionMenu", INDEX_HTML)
